...
INSERT INTO `category_config` VALUES (10, '分享', 'SHARE', 'FORUM', 1, 0, 1, '2025-11-13 05:29:55', '2025-11-15 01:55:37');
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '回复表' ROW_FORMAT = Dynamic;
...
INSERT INTO `permission` VALUES (5, 'page:home:all', '访问首页-全部', 'PAGE', '访问首页全部分类', NULL, NULL, NULL, 0, 5, 1, '2025-11-13 06:42:17', '2025-11-13 06:42:17');
INSERT INTO `permission` VALUES (6, 'page:home:pack', '访问首页-整合包', 'PAGE', '访问首页整合包分类', NULL, NULL, NULL, 0, 6, 1, '2025-11-13 06:42:17', '2025-11-13 06:42:17');
INSERT INTO `permission` VALUES (7, 'page:home:mod', '访问首页-MOD', 'PAGE', '访问首页MOD分类', NULL, NULL, NULL, 0, 7, 1, '2025-11-13 06:42:17', '2025-11-13 06:42:17');
INSERT INTO `permission` VALUES (8, 'page:home:resource', '访问首页-资源包', 'PAGE', '访问首页资源包分类', NULL, NULL, NULL, 0, 8, 1, '2025-11-13 06:42:17', '2025-11-13 06:42:17');
INSERT INTO `permission` VALUES (9, 'resource:create', '创建资源', 'ACTION', '创建新的资源，需要resource:create权限', NULL, '/api/resource', 'POST', 0, 10, 1, '2025-11-13 06:42:17', '2025-11-15 00:32:04');
INSERT INTO `permission` VALUES (10, 'resource:read', '查看资源', 'ACTION', '根据ID获取资源的详细信息', NULL, '/api/resource/{id}', 'GET', 0, 11, 1, '2025-11-13 06:42:17', '2025-11-15 00:32:57');
INSERT INTO `permission` VALUES (11, 'resource:update', '修改资源', 'ACTION', '更新资源信息 需要resource:update权限', NULL, '/api/resource/{id}', 'PUT', 0, 12, 1, '2025-11-13 06:42:17', '2025-11-15 00:37:31');
INSERT INTO `permission` VALUES (12, 'resource:delete', '删除资源', 'ACTION', '删除资源，只能删除自己创建的资源', NULL, '/api/resource/{id}', 'DELETE', 0, 13, 1, '2025-11-13 06:42:17', '2025-11-15 00:45:08');
INSERT INTO `permission` VALUES (13, 'post:create', '创建帖子', 'ACTION', '发布新帖子，需要post:create权限', NULL, '/api/forum/posts', 'POST', 0, 20, 1, '2025-11-13 06:42:17', '2025-11-15 00:45:29');
INSERT INTO `permission` VALUES (14, 'post:read', '查看帖子', 'ACTION', '根据ID获取帖子的详细信息', NULL, '/api/forum/posts/{id}', 'GET', 0, 21, 1, '2025-11-13 06:42:17', '2025-11-15 00:45:57');
INSERT INTO `permission` VALUES (15, 'post:update', '修改帖子', 'ACTION', '更新帖子信息，只能更新自己发布的帖子', NULL, '/api/forum/posts/{id}', 'PUT', 0, 22, 1, '2025-11-13 06:42:17', '2025-11-15 00:46:16');
INSERT INTO `permission` VALUES (16, 'post:delete', '删除帖子', 'ACTION', '删除帖子，只能删除自己发布的帖子', NULL, '/api/forum/posts/{id}', 'DELETE', 0, 23, 1, '2025-11-13 06:42:17', '2025-11-15 00:46:56');
...
INSERT INTO `permission` VALUES (35, 'admin:role:delete', '删除角色', 'ACTION', '删除角色，需要admin:role:delete或admin:role:manage权限', NULL, '/api/admin/roles/{id}', 'DELETE', 0, 62, 1, '2025-11-13 06:42:17', '2025-11-15 00:50:18');
INSERT INTO `permission` VALUES (36, 'resource:download', '下载文件', 'ACTION', '从OSS下载文件，需要resource:download权限', NULL, '/api/files/{id}/download', 'GET', 0, 63, 1, '2025-11-14 07:11:50', '2025-11-15 00:49:57');
INSERT INTO `permission` VALUES (37, 'resource:audit', '审核资源', 'ACTION', '管理员审核 资源信息，需要admin:resource:audit权限', '', '/api/admin/resources/{id}', 'PUT', 0, 0, 1, '2025-11-15 00:44:26', '2025-11-15 00:44:26');
INSERT INTO `permission` VALUES (38, 'admin:permission:read', '获取所有权限列表', 'ACTION', '分页获取权限列表，支持按类型筛选和关键词搜索', NULL, '/api/admin/permissions', 'GET', 0, 0, 1, '2025-11-15 01:44:31', '2025-11-15 01:50:04');
...
INSERT INTO `role_permission` VALUES (240, 2, 'resource:audit', '审核资源', '2025-11-15 01:41:20');
